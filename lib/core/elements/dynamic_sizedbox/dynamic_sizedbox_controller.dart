...
import 'package:hana_sdk/core/elements/dynamic_sizedbox/dynamic_sizedbox.dart';
...
class DynamicSizedBoxController extends StatefulWidget {
  final DynamicSizedBoxModel controller;
  final FormController formController;

  const DynamicSizedBoxController({
    super.key,
  ...
  @override
  State<DynamicSizedBoxController> createState() =>
      _DynamicSizedBoxControllerState();
}

class _DynamicSizedBoxControllerState extends State<DynamicSizedBoxController> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    DynamicSizedBoxModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicSizedBoxModel.fromJson(style);
              } else if (style is DynamicSizedBoxModel) {
    ...
    final displayController = DynamicSizedBoxModel(
    ...
    Widget? formWidgets;
    if (!containsAllPrerequisites) {
      if (displayController.items != null && displayController.items != {}) {
