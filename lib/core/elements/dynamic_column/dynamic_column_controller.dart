...
import 'package:hana_sdk/core/elements/dynamic_column/dynamic_column.dart';
...
class DynamicColumnController extends StatefulWidget {
  final DynamicColumnModel controller;
  final FormController formController;

  const DynamicColumnController({
    super.key,
  ...
  @override
  State<DynamicColumnController> createState() =>
      _DynamicColumnControllerState();
}

class _DynamicColumnControllerState extends State<DynamicColumnController> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    DynamicColumnModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicColumnModel.fromJson(style);
              } else if (style is DynamicColumnModel) {
    ...
    final displayController = DynamicColumnModel(
