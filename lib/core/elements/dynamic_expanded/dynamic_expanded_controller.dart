...
import 'package:hana_sdk/core/elements/dynamic_expanded/dynamic_expanded.dart';
...
class DynamicExpandedController extends StatefulWidget {
  final DynamicExpandedModel controller;
  final FormController formController;

  const DynamicExpandedController({
    super.key,
  ...
  @override
  State<DynamicExpandedController> createState() =>
      _DynamicExpandedControllerState();
}

class _DynamicExpandedControllerState extends State<DynamicExpandedController> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    DynamicExpandedModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicExpandedModel.fromJson(style);
              } else if (style is DynamicExpandedModel) {
    ...
    final displayController = DynamicExpandedModel(
      flex: containsAllPrerequisitesDesign?.flex ?? widget.controller.flex,
