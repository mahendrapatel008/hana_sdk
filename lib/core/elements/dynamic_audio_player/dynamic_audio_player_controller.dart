...
class DynamicAudioPlayerController extends StatefulWidget {
  final DynamicAudioPlayerModel controller;
  final FormController formController;

  const DynamicAudioPlayerController({
    super.key,
  ...
  @override
  State<DynamicAudioPlayerController> createState() =>
      _DynamicAudioPlayerControllerState();
}

class _DynamicAudioPlayerControllerState
    extends State<DynamicAudioPlayerController> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    DynamicAudioPlayerModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicAudioPlayerModel.fromJson(style);
              } else if (style is DynamicAudioPlayerModel) {
    ...
    final displayController = DynamicAudioPlayerModel(
      audioUrl: containsAllPrerequisitesDesign?.audioUrl ??
          widget.controller.audioUrl,
      ...
      canScrub: containsAllPrerequisitesDesign?.canScrub ??
          widget.controller.canScrub,
      inactiveTrackColor: containsAllPrerequisitesDesign?.inactiveTrackColor ??
          widget.controller.inactiveTrackColor,
      activeTrackColor: containsAllPrerequisitesDesign?.activeTrackColor ??
          widget.controller.activeTrackColor,
      thumbColor: containsAllPrerequisitesDesign?.thumbColor ??
          widget.controller.thumbColor,
      trackHeight: containsAllPrerequisitesDesign?.trackHeight ??
          widget.controller.trackHeight,
      enabledThumbRadius: containsAllPrerequisitesDesign?.enabledThumbRadius ??
          widget.controller.enabledThumbRadius,
