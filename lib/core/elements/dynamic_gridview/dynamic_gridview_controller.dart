...
import 'package:hana_sdk/core/elements/dynamic_gridview/dynamic_gridview.dart';
...
class DynamicGridViewController extends StatefulWidget {
  final DynamicGridViewModel controller;
  final FormController formController;

  const DynamicGridViewController({
    super.key,
  ...
  @override
  State<DynamicGridViewController> createState() =>
      _DynamicGridViewControllerState();
}

class _DynamicGridViewControllerState extends State<DynamicGridViewController> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    DynamicGridViewModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicGridViewModel.fromJson(style);
              } else if (style is DynamicGridViewModel) {
    ...
    final displayController = DynamicGridViewModel(
      ...
      crossAxisCount: containsAllPrerequisitesDesign?.crossAxisCount ??
          widget.controller.crossAxisCount,
      mainAxisSpacing: containsAllPrerequisitesDesign?.mainAxisSpacing ??
          widget.controller.mainAxisSpacing,
      crossAxisSpacing: containsAllPrerequisitesDesign?.crossAxisSpacing ??
          widget.controller.crossAxisSpacing,
      childHeight: containsAllPrerequisitesDesign?.childHeight ??
          widget.controller.childHeight,
