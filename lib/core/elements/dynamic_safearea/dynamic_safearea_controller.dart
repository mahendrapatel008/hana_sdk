...
import 'package:hana_sdk/core/elements/dynamic_safearea/dynamic_safearea.dart';
...
class DynamicSafeareaController extends StatefulWidget {
  final DynamicSafeareaModel controller;
  final FormController formController;

  const DynamicSafeareaController({
    super.key,
  ...
  @override
  State<DynamicSafeareaController> createState() =>
      _DynamicSafeareaControllerState();
}

class _DynamicSafeareaControllerState extends State<DynamicSafeareaController> {
  @override
  Widget build(BuildContext context) {
    ...
    DynamicSafeareaModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicSafeareaModel.fromJson(style);
              } else if (style is DynamicSafeareaModel) {
    ...
    final displayController = DynamicSafeareaModel(
      ...
      maintainBottomViewPadding:
          containsAllPrerequisitesDesign?.maintainBottomViewPadding ??
              widget.controller.maintainBottomViewPadding,
      minimum:
          containsAllPrerequisitesDesign?.minimum ?? widget.controller.minimum,
