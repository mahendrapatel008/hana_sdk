...
import 'package:hana_sdk/core/elements/dynamic_spacer/dynamic_spacer.dart';
...
class DynamicSpacerController extends StatefulWidget {
  final DynamicSpacerModel controller;
  final FormController formController;

  const DynamicSpacerController({
    super.key,
  ...
  @override
  State<DynamicSpacerController> createState() =>
      _DynamicSpacerControllerState();
}

class _DynamicSpacerControllerState extends State<DynamicSpacerController> {
  ...
  Widget build(BuildContext context) {
    ...
    DynamicSpacerModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicSpacerModel.fromJson(style);
              } else if (style is DynamicSpacerModel) {
    ...
    final displayController = DynamicSpacerModel(
