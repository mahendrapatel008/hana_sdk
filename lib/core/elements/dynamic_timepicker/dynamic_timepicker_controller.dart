...
import 'package:hana_sdk/core/elements/dynamic_timepicker/dynamic_timepicker.dart';
...
class DynamicTimePickerController extends StatefulWidget {
  final DynamicTimePickerModel controller;
  final FormController formController;

  const DynamicTimePickerController({
    super.key,
  ...
  @override
  State<DynamicTimePickerController> createState() =>
      _DynamicTimePickerControllerState();
}

class _DynamicTimePickerControllerState
    extends State<DynamicTimePickerController> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    DynamicTimePickerModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicTimePickerModel.fromJson(style);
              } else if (style is DynamicTimePickerModel) {
    ...
    final displayController = DynamicTimePickerModel(
      ...
      initialTime: containsAllPrerequisitesDesign?.initialTime ??
          widget.controller.initialTime,
