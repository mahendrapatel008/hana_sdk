...
import 'package:hana_sdk/core/elements/dynamic_qr_generator/dynamic_qr_generator.dart';
...
class DynamicQrGeneratorController extends StatefulWidget {
  final DynamicQrGeneratorModel controller;
  final FormController formController;

  const DynamicQrGeneratorController({
    super.key,
  ...
  @override
  State<DynamicQrGeneratorController> createState() =>
      _DynamicQrGeneratorControllerState();
}

class _DynamicQrGeneratorControllerState
    extends State<DynamicQrGeneratorController> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    DynamicQrGeneratorModel? containsAllPrerequisitesDesign;
            ...
            if (remainingPrerequisites.isNotEmpty) {
              ...
              if (style is Map<String, dynamic>) {
                containsAllPrerequisitesDesign =
                    DynamicQrGeneratorModel.fromJson(style);
              } else if (style is DynamicQrGeneratorModel) {
    ...
    final displayController = DynamicQrGeneratorModel(
